package chat.wewe.android.widget;
...
public class RoomToolbar extends Toolbar {
  ...
  private void initialize(Context context) {
    ...
    taskAdd = findViewById(R.id.task_btn);
    videoCallBtn = findViewById(R.id.call_video_btn);
    callBtn = findViewById(R.id.call_btn);

    privateChannelDrawable = VectorDrawableCompat.create(getResources(), R.drawable.ic_chanel_vector, null);
    publicChannelDrawable = VectorDrawableCompat.create(getResources(), R.drawable.ic_public_chanel_vector, null);
    ...
    taskAdd.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        Log.d("TEST_WEWE","RRQ");
        mListener.onClickTask();
      }
    });
  }
