...
import static chat.wewe.android.activity.Constants.SKU_DELAROY_MONTHLY;
import static chat.wewe.android.activity.Constants.SKU_DELAROY_SIXMONTH;
import static chat.wewe.android.activity.Constants.SKU_DELAROY_THREEMONTH;
import static chat.wewe.android.activity.Constants.SKU_DELAROY_YEARLY;
import static chat.wewe.android.activity.Constants.base64EncodedPublicKey;
    ...
    public void updateUi() {
        ...
        if (mSubscribedToDelaroy) {
           // startActivity(new Intent(getApplicationContext(), MainActivity.class));
            getSharedPreferences("Sub", MODE_PRIVATE).edit().putBoolean("Sub",true).commit();
            finish();
        } else {
            getSharedPreferences("Sub", MODE_PRIVATE).edit().putBoolean("Sub",false).commit();
