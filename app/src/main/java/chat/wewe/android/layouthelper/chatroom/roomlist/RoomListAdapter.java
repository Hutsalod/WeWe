...
public class RoomListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public ArrayList<String> arrayListList = new ArrayList<>();
  public List<RoomSidebar> roomSidebarList = Collections.emptyList();
  public List<Spotlight> spotlightList = Collections.emptyList();
  public List<RoomListHeader> roomListHeaders = Collections.emptyList();
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    if (mode == MODE_ROOM) {
      ...
      ((RoomListItemViewHolder) holder).bind(roomSidebar);
        arrayListList.add(roomSidebarList.get(position - getTotalHeadersBeforePosition(position)).getRoomId());
  ...
  private void sortRoomList() {
    ...
    arrayListList.clear();
    Collections.sort(roomSidebarList, (anotherRoom, roomSidebar) -> {
      ...
      return Long.toString(roomSidebar.getUpdateAt()).compareTo(Long.toString(anotherRoom.getUpdateAt()));
    });
  }
