...
/**
 * SlidingPaneLayouts provides a horizontal, multi-pane layout for use at the top level
 ...
 * in the SlidingPaneLayouts. When this occurs the user may slide the topmost view out of the way
 ...
 *
 * <p>Thanks to this sliding behavior, SlidingPaneLayouts may be suitable for creating layouts
 ...
 *
 * <p>SlidingPaneLayouts is distinct from a navigation drawer as described in the design
 * guide and should not be used in the same scenarios. SlidingPaneLayouts should be thought
 * of only as a way to allow a two-pane layout normally used on larger screens to adapt to smaller
 * screens in a natural way. The interaction patterns expressed by SlidingPaneLayouts imply
 ...
 *
 * <p>Appropriate uses of SlidingPaneLayouts include pairings of panes such as a contact list and
 * subordinate interactions with those contacts, or an email thread list with the content pane
 * displaying the contents of the selected thread. Inappropriate uses of SlidingPaneLayouts include
 ...
 *
 * <p>Like {@link android.widget.LinearLayout LinearLayout}, SlidingPaneLayouts supports
 ...
 */
public class SlidingPaneLayouts extends ViewGroup {
    private static final String TAG = "SlidingPaneLayouts";
    ...
    public SlidingPaneLayouts(@NonNull Context context) {
        this(context, null);
    }

    public SlidingPaneLayouts(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingPaneLayouts(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SlidingPaneLayouts parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(SlidingPaneLayouts parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SlidingPaneLayouts.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SlidingPaneLayouts.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SlidingPaneLayouts.this) {
